      ...
      <div className="aboutus-container">
        ...
        <div className="aboutus-hero">
          <div className="aboutus-hero-content">
            ...
            <div className="aboutus-text-content">
              <p className="aboutus-text">
                <strong>Electropower</strong> fue fundada por <strong>Ángel Saldaño</strong>, profesional con amplia experiencia en empresas de primer nivel como Farmaco Argentina, Laboratorios Roche, Roemmers y Procter & Gamble. Durante más de trece años formó parte de <strong>Edenor</strong>, desempeñándose en áreas clave como calidad de producto, reclamos, media tensión y reparaciones.
              </p>
              <p className="aboutus-text">
                En <strong>2019</strong>, Electropower inicia su camino independiente, ampliando su alcance y consolidándose como una empresa que combina trayectoria técnica, compromiso y servicio integral. Desde entonces, se ha especializado en brindar soluciones eléctricas, de climatización y construcción con un enfoque en la innovación en sistemas eléctricos de baja y media tensión.
              </p>
            </div>
          </div>
          ...
          <div className="aboutus-hero-image">
            ...
            >
              <img src={imagenAbout} alt="ElectroPower Team" className="aboutus-image" />
        ...
        <div className="aboutus-services-section">
          <div className="services-section-header">
            ...
            <h3 className="services-section-title">Soluciones integrales con calidad garantizada</h3>
            <p className="services-section-description">
              Brindamos soluciones integrales en los rubros eléctrico, edilicio y de climatización, garantizando calidad, seguridad y cumplimiento normativo.
            </p>
          </div>
        ...
        <div className="coverage-section">
          <div className="coverage-content">
            ...
            <p className="coverage-description">
              Electropower ofrece sus servicios en todo el territorio argentino, garantizando la misma calidad y compromiso sin importar la ubicación del cliente.
            </p>
            <div className="clients-logos-grid">
              <div className="client-logo-card">
                <img src={logoQuest} alt="Colegio Quest" className="client-logo" />
              </div>
              <div className="client-logo-card">
                <img src={logoYPF} alt="YPF" className="client-logo client-logo-ypf" />
              </div>
              <div className="client-logo-card">
                <img src={logoNovaPaking} alt="Nova Parking" className="client-logo" />
              </div>
              <div className="client-logo-card">
                <img src={logoAkapol} alt="Akapol" className="client-logo" />
              </div>
              <div className="client-logo-card">
                <img src={logoElena} alt="Elena Pardas Administraciones" className="client-logo client-logo-elena" />
              </div>
              <div className="client-logo-card">
              ...
              <div className="client-logo-card">
                <img src={logoTerranova} alt="Terranova" className="client-logo" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="aboutus-partners">
          <div className="partners-header">
            ...
            <p className="partners-description">
              Colaboramos con las principales distribuidoras eléctricas de Argentina y empresas del sector, 
            ...
            <div className="galan-alliance-highlight">
              ...
              <p className="alliance-text">
                <strong>Electropower y Grupo Galán</strong> establecieron una alianza estratégica para potenciar la comercialización, instalación y servicio integral de grupos electrógenos (7 kVA - 500 kVA), combinando trayectoria comercial con solidez técnica y operativa.
              </p>
            </div>
          </div>
          ...
          <div className="partners-grid">
            ...
            <div 
              ...
              style={{ background: 'linear-gradient(180deg, #000000 0%, #3a3a3a 100%)' }}
            >
              <div className="partner-card-overlay-yellow"></div>
              <div className="new-badge">
                <svg viewBox="0 0 24 24" fill="currentColor" className="new-badge-icon">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                Nueva Alianza
              </div>
              <div className="partner-card-content">
                <img src={logoGalan} alt="Grupo Galán" className="partner-logo partner-logo-galan" />
                ...
                <div className="partner-card-tag partner-card-tag-yellow">Partner Oficial</div>
              </div>
            </div>
          </div>
        </div>
